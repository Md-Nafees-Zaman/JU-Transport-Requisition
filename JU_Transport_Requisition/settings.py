"""
Django settings for JU_Transport_Requisition project.
"""
import os
...
ROOT_URLCONF = 'JU_Transport_Requisition.urls'
...
WSGI_APPLICATION = 'JU_Transport_Requisition.wsgi.application'
